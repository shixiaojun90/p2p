...
<base target="_self" />
<div class="main">
 <div class="hint" style="margin-top:60px;padding-left:16px;padding-right:16px;">
  <img src="/style/newmobile/images/right.png" /><font><?php echo ($message); ?></font>
  <p>系统将在 <span style="color:blue;font-weight:bold">3</span> 秒后自动跳转,如果不想等待,直接点击 <A HREF="<?php echo ($jumpUrl); ?>">这里</A> 跳转
          或者 <a href="<?php echo U('/M');?>">返回首页</a></p>
 </div>
</div>
</body>
</html>