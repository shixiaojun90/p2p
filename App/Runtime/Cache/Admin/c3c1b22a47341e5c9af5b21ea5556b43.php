...
<div class="form2">
	...
	<dl class="lineD"><dt>文章标题：</dt><dd><input name="title" id="title"  class="input" type="text" value="" maxlength='30'><span id="tip_title" class="tip">* 标题最大长度30个字</span></dd></dl>
	<dl class="lineD"><dt>所属栏目：</dt><dd><select name="type_id" id="type_id"   class="c_select"><option value="">--请选择--</option><?php foreach($type_list as $key=>$v){ if("" && $v[""]==$_X[""]){ ?><option value="<?php echo ($v["id"]); ?>" selected="selected"><?php echo ($v["type_name"]); ?></option><?php }else{ ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["type_name"]); ?></option><?php }} ?></select><span id="tip_type_id" class="tip">*</span></dd></dl>
	...
	<dl class="lineD"><dt>文章关键字：</dt><dd><input name="art_keyword" id="art_keyword"  class="input" type="text" value="" ><span id="tip_art_keyword" class="tip">SEO元素</span></dd></dl>
	<dl class="lineD"><dt>文章简介：</dt><dd><textarea name="art_info" id="art_info"  class="areabox" ></textarea><span id="tip_art_info" class="tip">SEO元素</span></dd></dl>
	...
	<dl class="lineD"><dt>文章属性：</dt><dd><?php $i=0;$___KEY=array ( 0 => '普通', 1 => '跳转', ); foreach($___KEY as $k=>$v){ if(strlen("1")==1 && $i==0){ ?><input type="radio" name="art_set" value="<?php echo ($k); ?>" id="art_set_<?php echo ($i); ?>" checked="checked" /><?php }elseif(("1"=="key1"&&$_X["_Y"]==$k)||(""=="value"&&$_X["_Y"]==$v)){ ?><input type="radio" name="art_set" value="<?php echo ($k); ?>" id="art_set_<?php echo ($i); ?>" checked="checked" /><?php }else{ ?><input type="radio" name="art_set" value="<?php echo ($k); ?>" id="art_set_<?php echo ($i); ?>" /><?php } ?><label for="art_set_<?php echo ($i); ?>"><?php echo ($v); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;<?php $i++; } ?></dd></dl>
	<!--<dl class="lineD"><dt>标题颜色：</dt><dd><input name="title_style" id="title_style"  class="input" type="text" value="" ></dd></dl>-->
	<dl class="lineD"><dt>文章作者：</dt><dd><input name="art_writer" id="art_writer"  class="input" type="text" value="" ></dd></dl>
	<dl class="lineD"><dt>跳转地址：</dt><dd><input name="art_url" id="art_url"  class="input" type="text" value="" ><span id="tip_art_url" class="tip">仅在文章属性为跳转时有效</span></dd></dl>
