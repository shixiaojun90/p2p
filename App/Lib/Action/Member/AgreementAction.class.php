...
class AgreementAction extends MCommonAction {
 ...
 public function downfile(){
		...
		$binfo = M('borrow_info')->field('id,repayment_type,borrow_duration,borrow_uid,borrow_type,borrow_use,borrow_money,full_time,add_time,borrow_interest_rate,deadline,second_verify_time,danbao')->find($iinfo['borrow_id']);
		...
		$danbao=M('article')->field('title')->where("id = {$binfo['danbao']}")->find();
