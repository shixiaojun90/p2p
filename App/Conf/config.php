...
return array(
    ...
    'LOAD_EXT_CONFIG' => 'crons,banks', //加载扩展配置文件
    ...
    'LOAN_URL' => array(
       /**   'register' => 'http://218.4.234.150:88/main/loan/toloanregisterbind.action', //开户接口地址
		...
		'verifyname'  =>'http://218.4.234.150:88/main/authentication/identityMatching.action',//实名认证接口
      ...
      'withdraw'=>'https://withdrawals.moneymoremore.com/loan/toloanwithdraws.action',
      'charge'=>'https://recharge.moneymoremore.com/loan/toloanrecharge.action', //充值地址
      //'chargemobile'=>'https://recharge.moneymoremore.com', //充值地址
      ...
      'authorize'=>'https://auth.moneymoremore.com/loan/toloanauthorize.action',//授权接口
      'audit' => 'https://audit.moneymoremore.com/loan/toloantransferaudit.action', // 审核接口
      'toloanfastpay' => 'https://loan.moneymoremore.com/loan/toloanfastpay.action', // 三合一接口
	  'verifyname'  =>'https://loan.moneymoremore.com/authentication/identityMatching.action',//实名认证接口
   
    ),
    //数据库配置
    'DB_TYPE' => 'mysql',
    'DB_HOST' => 'localhost', // '192.168.0.103',//'192.168.0.118',
    'DB_NAME' => 'hebangjiedai', //'tuoguancj_cn',
    'DB_USER' => 'root',
    'DB_PWD' => 'hbjd123',
    'DB_PORT' => '3306',
    'DB_PREFIX' => 'lzh_',
    ...
    'URL_ROUTE_RULES' => array(
        ...
        '/^tinvest\/index.html\?(.*)$/' => 'Home/tinvest/index?:1', //企业直投页
        '/^tinvest\/(\d+).html$/' => 'Home/tinvest/tdetail?id=:1', //企业直投页
        '/^tinvest\/(\d+).html\?(.*)$/' => 'Home/tinvest/tdetail?id=:1:2', //企业直投祥情页


        '/^fund\/index.html\?(.*)$/' => 'Home/fund/index?:1',           //定投宝列表页
        '/^fund\/(\d+).html$/' => 'Home/fund/tdetail?id=:1',            //定投宝内页
        '/^fund\/(\d+).html\?(.*)$/' => 'Home/fund/tdetail?id=:1:2', //定投宝投详情页
        

        '/^Market\/(\d+).html$/' => 'Home/Market/detail?id=:1', //企业直投内页
         '/^Market\/index.html\?(.*)$/' => 'Home/Market/index?:1', //积分商城直投列表页
    ...
    'SYS_URL' => array('admin', 'borrow', 'member', 'invest', 'tinvest', 'fund','tool', 'feedback', 'service', 'bid', 'Market', 'main', 'm', 'mcenter', 'debt', 'bangzhu'),
