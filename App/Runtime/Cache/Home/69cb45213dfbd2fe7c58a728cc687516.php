...
<title><?php echo ($vo["type_name"]); ?>-<?php echo ($glo["web_name"]); ?>帮助中心</title>
      ...
      <div class="cms-details">
        <div class="article-list-wrap mgt">
          <div class="article-list mgt">
            <ul>
              <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vl): $mod = ($i % 2 );++$i;?><li class="changecolor"> <span class="item-title"><a href="<?php echo ($vl["arturl"]); ?>" title="<?php echo ($vl["title"]); ?>"  ><?php echo (cnsubstr($vl["title"],28)); ?></a></span> <span class="release-time"><?php echo (date("Y.m.d",$vl["art_time"])); ?></span> </li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
          </div>
