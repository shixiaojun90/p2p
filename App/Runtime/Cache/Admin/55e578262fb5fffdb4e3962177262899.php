...
<div class="form2">
	...
	<dl class="lineD"><span style="color:red; padding-left:100px;">【注】：模板内容不要太长，不要包含违法关键字，内容结尾请加网站签名，网站签名格式为：【网站名称】，这样可加快邮件接收速度！</span></dl>
		...
		<dl class="lineD"><dt>投标成功：</dt><dd><textarea name="sms[investmoney][content]|de_xie=###" id="sms[investmoney][content]|de_xie=###"  class="areabox" ><?php echo ($smsTxt["investmoney"]["content"]); ?></textarea><span id="tip_sms[investmoney][content]|de_xie=###" class="tip">#USERANEM#表示用户名,#MONEY#表示金额</span><input type="checkbox" name="sms[investmoney][enable]" value="1" <?php if($smsTxt['investmoney']['enable'] == 1): ?>checked="checked"<?php endif; ?> />开启</dd></dl>
		<dl class="lineD"><dt>购买债权成功：</dt><dd><textarea name="sms[debtmoney][content]|de_xie=###" id="sms[debtmoney][content]|de_xie=###"  class="areabox" ><?php echo ($smsTxt["debtmoney"]["content"]); ?></textarea><span id="tip_sms[debtmoney][content]|de_xie=###" class="tip">#USERANEM#表示用户名,#MONEY#表示金额</span><input type="checkbox" name="sms[debtmoney][enable]" value="1" <?php if($smsTxt['debtmoney']['enable'] == 1): ?>checked="checked"<?php endif; ?> />开启</dd></dl>
		...
		<dl class="lineD"><dt>登录找回密码时发送验证码：</dt><dd><textarea name="sms[logincode]|de_xie=###" id="sms[logincode]|de_xie=###"  class="areabox" ><?php echo ($smsTxt["logincode"]); ?></textarea><span id="tip_sms[logincode]|de_xie=###" class="tip">#USERANEM#表示用户名,#CODE#表示验证码</span></dd></dl><!-- mxl 20150611 -->
		<dl class="lineD"><dt>登录找回密码时发送新密码：</dt><dd><textarea name="sms[loginpass]|de_xie=###" id="sms[loginpass]|de_xie=###"  class="areabox" ><?php echo ($smsTxt["loginpass"]); ?></textarea><span id="tip_sms[loginpass]|de_xie=###" class="tip">#USERANEM#表示用户名,#CODE#表示新密码</span></dd></dl><!-- mxl 20150611 -->
	</div><!--tab2-->
