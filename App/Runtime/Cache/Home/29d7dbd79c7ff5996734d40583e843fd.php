...
<div class="cms_nav">
  ...
  <div id="content3B" style="margin:0 auto;">
    ...
    <div class="tool_title" style="margin-top: 10px;padding-bottom:10px;">
      ...
      <div class="funframe">
        <ul class="rslist">
          <li> <span class="n_text">借款期限：</span>
            <input name="date_limit" class="date_limit" type="text" title="借款期限" value="1">
          ...
          <li> <span class="n_text">借款利率：</span>
          ...
          <li style="margin-top:0px;"> <span class="n_text">借款金额：</span>
            <input name="amount" class="amount" type="text" value="10000" title="借款金额">
            元 </li>
          <li> <span class="n_text">借款管理费：</span>
            <input name="borrow_manage" class="borrow_manage" type="text" title="借款管理费" value="0.5">
            <span class="manage_unit">% 每月</span> </li>
          <!-- <li> <span class="n_text">风险准备金：</span>
            <input name="risk_reserve" class="risk_reserve" type="text" title="风险准备金" value="2">
            % </li> -->
          <li> <span class="n_text">还款方式：</span>
      ...
      $(".addbtn").click(function(){
        $.ajax({
          ...
          data: {
            ...
            "amount":$(".amount").val(),
            "borrow_manage":$(".borrow_manage").val(),
            "risk_reserve":$(".risk_reserve").val(),
