...
<title><?php echo ($vo["title"]); ?>-<?php echo ($glo["web_name"]); ?>帮助中心</title>
...
<!--中部开始-->
<div class="main h50 ft16 line3-5e">&nbsp;&nbsp;&nbsp;首页 > <?php echo ($wo["type_name"]); ?></div> 
      ...
      <div class="cms-details">
        <div class="article-list-wrap mgt">
          <table width="720" border="0" cellspacing="0" cellpadding="0" style="margin:0 auto;">
            <tr>
              <td height="50" align="center" valign="middle" style="font-size:24px; color:#666;" title="<?php echo ($vo["title"]); ?>"><?php echo (cnsubstr($vo["title"],26)); ?></td>
            </tr>
            <tr>
              <td height="50" align="center" valign="middle" style="border-bottom:1px solid #dedede;">发布时间：<?php echo (date("Y-m-d H:i",$vo["art_time"])); ?></td>
            </tr>
            <tr>
              <td>
                <iframe scrolling="no" frameborder="0" height="100%" id="mainFrame" width="100%" onload='IFrameReSize("mainFrame");IFrameReSizeWidth("mainFrame");' src="<?php echo U('Help/fram', array('id'=>$id));?>" ></iframe>
              </td>
            </tr>
			<tr>
              <td>
                <a href="__ROOT__/<?php echo ($wo["type_nid"]); ?>/index.html" class="blue float right">返回列表>></a>
              </td>
            </tr>
          </table>
        </div>
