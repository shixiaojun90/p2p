...
<div class="so_main">
  ...
  <div class="form2">
    <form method="post" action="__URL__/doEdit<?php echo ($xact); ?>" onsubmit="return subcheck();" enctype="multipart/form-data" target="myIframe">
      ...
      <div id="tab_1">
		...
		<?php if($_SESSION['listaction'] == 'waitverify2'): ?><dl class="lineD">
          <dt>借款管理费：</dt>
          <dd>
           <?php echo ($borrow_fee); ?>
          </dd>
...
function getEditorWordCount() {
	...
	return count;
		  ...
		  <!-- 编辑器调用开始 -->
				<textarea name="borrow_info" id="borrow_info" style="width:650px;height:200px;"><?php echo ($vo["borrow_info"]); ?></textarea>
				<script>
				
					loadEditor("borrow_info");
