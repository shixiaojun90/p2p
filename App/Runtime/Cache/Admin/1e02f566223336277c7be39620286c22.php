  ...
  <div class="list">
    <table id="area_list" width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr overstyle='on' id="list_<?php echo ($vo["id"]); ?>">
		  ...
		  <td><?php echo (cnsubstr($vo["borrow_name"],12)); ?></td>
		  <td><?php if($vo["borrow_type"] == 7): ?>定投<?php elseif($vo["borrow_type"] == 6): ?>直投<?php else: ?>散标<?php endif; ?></td>
          <td><?php echo ($vo["user_name"]); ?></td>
          <td><?php echo ($vo["capital"]); ?></td>
          <td><?php echo ($vo["interest"]); ?></td>
          <td><a href="/admin/trepayment/repayment?borrow_id=<?php echo ($vo["borrow_id"]); ?>">[还款明细]</a> </td>
