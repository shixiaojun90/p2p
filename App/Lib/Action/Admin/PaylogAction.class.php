...
class PaylogAction extends ACommonAction
{
    ...
    */
	...
	public function _listFilter($list){
	 	$listType = C('PAYLOG_TYPE');
	 	$payType = array('off'=>'线下充值','gfb'=>'国付宝','ips'=>'环迅支付','chinabank'=>'网银在线','baofoo'=>'宝付','shengpay'=>'盛付通','tenpay'=>'财付通','ecpss'=>'汇潮支付','easypay'=>'易生支付','cmpay'=>'中国移动支付');
    ...
    */
    public function paylogonline()
    {
		...
		$listType[-1]="不限制";
		$this->assign('type_list',$listType);
		$field= 'id,uid,status,money,add_time,way,deal_user, loan_no';
		$map['loan_no'] = array('neq','');
		$this->_list(D('Paylog'),$field,$map,'id','DESC',$xtime);
        $this->display();
    }
    ...
    */
    public function line()
    {
		...
		$listType[-1]="不限制";
		$this->assign('type_list',$listType);
		$field= 'id,uid,status,money,add_time,way,deal_user,fee';
