...
<!--搜索/筛选会员-->
  ...
  <div id="search_div" style="display:none">
	...
	<div class="form2">
	<form method="get" action="__URL__/withdraw">
...
<!--搜索/筛选会员-->
  ...
  <div class="Toolbar_inbox">
    ...
    <a class="btn_a" href="__URL__/withdrawexport?<?php echo ($query); ?>"><span>将当前条件下数据导出为Excel</span></a>
  </div>
