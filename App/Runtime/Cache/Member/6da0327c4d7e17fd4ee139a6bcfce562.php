  ...
  <div class="login_form">
    <div class="form">
      ...
      <p style=" text-align:center; height:40px;">
        <?php if($loginconfig['qq']['enable'] == '1'): ?><img src="__ROOT__/Style/H/images/qq_n.png">&nbsp;<a href="__APP__/member/oauth/qq/">QQ账号登录</a><?php endif; ?>
        &nbsp;&nbsp;
        <?php if($loginconfig['sina']['enable'] == '1'): ?><img src="__ROOT__/Style/H/images/sina_n.png">&nbsp;<a href="__APP__/member/oauth/sina/">新浪微博账号登录</a><?php endif; ?>
      </p>
    </div>
  </div>
</div>
