<?php if (!defined('THINK_PATH')) exit(); if($id_status == '1'): ?><div class="top_account_bg">
...
<div style="overflow: auto; width: 594px; height: auto; text-align:center; padding:20px; font-size:18px" id="mybox2_content">
	<span style="font-size:12px;color:#999999;"><img src="__ROOT__/Style/M/images/zhuce1.gif" style="vertical-align:middle">&nbsp;&nbsp;亲爱的[<?php echo session('u_user_name');?>]，您好，你提交的身份认证正在审核中...</span>
</div>
<?php else: ?>
...
<?php if($id5_config['enable'] == 0): ?>身份证正面图片：<input type="file" onchange="ajaxFileUploads();" id="imgfile" name="imgfile" style="width:160px;height:21px;line-height:21px;font-size:14px;font-weight:bold;margin:5px;ime-mode:Disabled;"/><span style="margin-left:40px"><img id="loading_makeclub" style="display:none" src="__ROOT__/Style/Js/loading.gif" /></span>
