...
<body>
  ...
  <div class="marginpage">
      <h3 class="mainpagehader"> 充值提示 </h3>
	  
	   <div class="chargecash">
	
	        <ul>
		       
				 <li class="submit msg"> <?php echo ($msg); ?></li>
				 <li></li>
				 <li class="submit" > <input type="submit" id="submit"  value="用户中心"  class="buybutton"></li> 
