...
<div class="main h50 ft16 line3-5e">&nbsp;&nbsp;&nbsp;首页 > <?php echo ($vo["type_name"]); ?></div> 
      ...
      <div class="cms-details">
        <div class="article-list-wrap mgt">
          <table width="720" border="0" cellspacing="0" cellpadding="0" style="margin:0 auto;">
            ...
            <tr>         
              <td><iframe scrolling="no" frameborder="0" height="100%" id="mainFrame" width="100%" onload='IFrameReSize("mainFrame");IFrameReSizeWidth("mainFrame");' src="<?php echo U('Help/fram', array('type_nid'=>$vo['type_nid']));?>" ></iframe>
			  </td>
            </tr>
			<tr>
              <td>
                <a href="__ROOT__/" class="blue float right">返回首页>></a>
              </td>
            </tr>
          </table>
        </div>
