...
<div class="form2">
	...
	<div id="tab_1">
		<dl class="lineD"><dt>SMTP用户名：</dt><dd><input name="msg[stmp][user]" id="msg[stmp][user]"  class="input" type="text" value="<?php echo ($stmp_config["user"]); ?>" ><span id="tip_msg[stmp][user]" class="tip">如123456@qq.com</span></dd></dl>
		...
		<dl class="lineD"><dt>SMTP服务器：</dt><dd><input name="msg[stmp][server]" id="msg[stmp][server]"  class="input" type="text" value="<?php echo ($stmp_config["server"]); ?>" ><span id="tip_msg[stmp][server]" class="tip">如smtp.qq.com</span></dd></dl>
	</div><!--tab1-->
