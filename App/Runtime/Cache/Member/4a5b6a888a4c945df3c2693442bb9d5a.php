<?php if (!defined('THINK_PATH')) exit(); if($phone_status == '1'): ?><!-- <div style="overflow: auto; width: 594px; height: auto; padding:20px" id="mybox2_content"> <span style="font-size:12px;color:#999999;"><img src="__ROOT__/Style/M/images/zhuce1.gif" style="vertical-align:middle">&nbsp;&nbsp;亲爱的[<?php echo session('u_user_name');?>]，您好，您已通过手机验证</span> </div> -->
  <style type="text/css">
...
<script type="text/javascript">
	...
	var mbTest = /^(13|15|18|14|17)[0-9]{9}$/;
	var timer1 = null;
	var timer2 = null;
	var _verifyState = "1";
...
<div style="display: none; margin-top: 10px; padding: 0 20px;" id="part2">
  ...
  <div style="overflow: auto; width: 594px; height: auto; padding:20px" id="mybox2_content"> <span style="font-size:12px;color:#999999;"><img src="__ROOT__/Style/M/images/zhuce1.gif" style="vertical-align:middle">&nbsp;&nbsp;亲爱的[<?php echo session('u_user_name');?>]，您好，您提交的手机验证请求已进入系统审核队列，请耐心等待....</span> </div>
  <?php else: ?>
  <div style="overflow: auto; width: 594px; height: 435px;" id="mybox4_content">
    ...
    <div style="width:100%; height:270px;">
      ...
      <?php if($is_manual == '0'): ?><div style="width:80%; height:270px; line-height:30px;float:left;font-size:14px;"><span style="margin:20px;display:block; text-align:left;">您在<?php echo ($glo["web_name"]); ?>的充值提现等重要操作，都需要通过手机动态验证码！<br>
        ...
        <span style="font-size:12px;color:#999999;"><img src="__ROOT__/Style/M/images/zhuce1.gif" style="vertical-align:middle">&nbsp;&nbsp;请注意以下事项：</span><br>
    ...
    <div style="width:80%; height:270px; line-height:30px;float:left;font-size:14px;"><span style="margin:20px;display:block; text-align:left;">您在<?php echo ($glo["web_name"]); ?>的充值提现等重要操作，都需要通过手机动态验证码！<br>
      ...
      <span style="vertical-align:top;">手机号：
      <input type="text" onkeyup="value=this.value.replace(/D+/g,&quot;&quot;)" style="width:173px;height:21px;line-height:21px;font-size:14px;font-weight:bold;margin:5px;" onkeydown="$(&quot;#sendSMSTip&quot;).html(&quot;&quot;)" maxlength="11" id="txt_phone"><?php echo ($phone_status); ?>
      </span><br>
