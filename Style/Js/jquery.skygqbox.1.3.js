...
;(function($){
	...
	$.skygqbox = function(elements,s){
		...
		//弹框的显示初始化
		var WRAP = '<div id="skygqOverlay"></div><div class="wrap_out" id="wrapOut"><div class="wrap_in" id="wrapIn"><!--div id="wrapBar" class="wrap_bar"  onselectstart="return false;"><a href="javascript:void(0);" class="wrap_close" id="wrapClose">'+s.shut+'</a></div--><div class="wrap_body" id="wrapBody"></div></div></div>';
		$("body").append(WRAP);
